...
import com.geekbrains.weather.ui.city.HistoryFragment;
import com.geekbrains.weather.ui.city.InfoCityFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_settings:
                return true;
            case R.id.nav_web:
                addFragment(new GeoFragment(), R.id.content_frame);
                return true;
            case R.id.nav_note:
                addFragment(new PlanFragment(), R.id.content_frame);
                return true;
            case R.id.nav_info:
                return true;
        }
